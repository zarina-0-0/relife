...
st.markdown("**Зарплата:** Уменьшение фонда оплаты труда на 10% минимально влияет на мотивацию, а перераспределение задач позволит сохранить производительность")
st.markdown("**Аренда:** Рынок коммерческой недвижимости в большинстве случаев позволяет пересмотреть ставку аренды, особенно при заключении долгосрочного договора")
st.markdown("**Закупка зеркал:** Анализ рынка поставщиков зеркал может выявить более экономичные варианты. Сокращение объема закупок позволит временно перераспределить ресурсы.")
st.markdown("**Закупка одежды:** Заказ у производителей напрямую исключает наценки посредников. Пересмотр ассортимента на менее дорогие бренды снижает затраты без потери качества одежды.")
